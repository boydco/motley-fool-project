 ...
 *  
 */
class Motley_Fool_Stock_Advisor_Admin_Metaboxes {
	...
	public function add_metaboxes() {
		...
		add_meta_box(
			'motley_fool_stock_adviser_job_additional_info',
			apply_filters( $this->plugin_name . '-metabox-title-additional-info', esc_html__( 'Additional Info', 'motley-fool-stock-adviser' ) ),
			array( $this, 'metabox' ),
			'job',
			'normal',
			'default',
		...
		add_meta_box(
			'motley_fool_stock_adviser_job_requirements',
			apply_filters( $this->plugin_name . '-metabox-title-requirements', esc_html__( 'Job Requirements', 'motley-fool-stock-adviser' ) ),
			array( $this, 'metabox' ),
			'job',
			'normal',
			'default',
		...
		add_meta_box(
			'motley_fool_stock_adviser_job_files',
			apply_filters( $this->plugin_name . '-metabox-title-requirements', esc_html__( 'Related Files', 'motley-fool-stock-adviser' ) ),
			array( $this, 'metabox' ),
			'job',
			'side',
			'default',
	...
	public function metabox( $post, $params ) {
		...
		include( plugin_dir_path( __FILE__ ) . 'partials/motley-fool-stock-adviser-admin-metabox-' . $params['args']['file'] . '.php' );
	...
	public function save_files_order() {
		...
		check_ajax_referer( 'motley-fool-stock-adviser-file-order-nonce', 'fileordernonce' );
		...
		esc_html_e( 'File order saved.', 'motley-fool-stock-adviser' );
