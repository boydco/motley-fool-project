 ...
 *  
 */
class Motley_Fool_Stock_Advisor_Widget extends WP_Widget {
	...
	function __construct() {
		...
		$name 					= esc_html__( 'Motley Fool Stock Adviser', 'motley-fool-stock-adviser' );
		$opts['classname'] 		= '';
		$opts['description'] 	= esc_html__( 'Display Company Info in Sidebar', 'motley-fool-stock-adviser' );
	...
	function widget( $args, $instance ) {
		...
		include( plugin_dir_path( __FILE__ ) . 'partials/motley-fool-stock-adviser-display-widget.php' );
