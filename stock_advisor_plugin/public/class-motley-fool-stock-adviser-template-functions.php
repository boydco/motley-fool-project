...
class Motley_Fool_Stock_Advisor_Template_Functions {
	...
	public function single_post_content() {
		...
		include motley_fool_stock_adviser_get_template( 'single-post-content' );
	 ...
	 * @hooked 		motley-fool-stock-adviser-single-content 	15
	 */
	public function single_company_post_content() {

		include motley_fool_stock_adviser_get_template( 'single-company-post-content' );

	} // single_company_post_content()


	public function single_stock_sidebar() {

		include motley_fool_stock_adviser_get_template( 'single-post-sidebar' );

	} // single_post_content()


	public function stock_rec_sidebar() {

		include motley_fool_stock_adviser_get_template( 'single-stock-rec-sidebar' );

	} // single_stock_rec_sidebar()
	...
	public function single_post_title() {
		...
		include motley_fool_stock_adviser_get_template( 'single-post-title' );
